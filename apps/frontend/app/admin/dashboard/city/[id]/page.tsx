...
// import { useCity, useCitiesAssignment } from '@/lib/hooks/use-dashboard';
// import {
//     Pagination,
//     PaginationContent,
//     PaginationEllipsis,
...
//     const id = params.id as string; // This is the city name
//     const [page, setPage] = useState(1);
//     const pageSize = 10;
//     const { signout } = useAuth();

//     const { data: cityResponse, isLoading: cityLoading } = useCity(id);
//     const { data: cityAssignments, isLoading: assignmentsLoading } = useCitiesAssignment(id, page, pageSize);
...
//                 <h1 className="text-2xl font-bold text-slate-800">City Not Found</h1>
...
//                         </button>
//                         <div>
//                             <h2 className="text-xl font-bold text-slate-800">{city.name}</h2>
//                             <p className="text-xs text-slate-500 mt-1">Assignments and Performance for all staff in this city</p>
//                         </div>
//                     </div>
...
//                             <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/30 flex justify-between items-center">
//                                 <h3 className="text-sm font-bold text-slate-700 uppercase tracking-wide">City Staff Results</h3>
//                                 <div className="flex gap-4 text-xs font-medium">
//                                     <span className="text-slate-500">Staff Count: <span className="text-slate-700">{city.staffCount}</span></span>
//                                     <span className="text-slate-500">Passed: <span className="text-emerald-600">{city.passed}</span></span>
//                                 </div>
//                             </div>
...
//                                         </tr>
//                                     ) : (
//                                         cityAssignments?.data?.map(assignment => (
...
//                         {/* City Assignment Pagination */}
//                         {cityAssignments?.meta && cityAssignments.meta.totalPages > 1 && (
...
//                                         {Array.from({ length: cityAssignments.meta.totalPages }, (_, i) => i + 1).map((p) => {
//                                             if (
//                                                 p === 1 ||
//                                                 p === cityAssignments.meta.totalPages ||
//                                                 (p >= page - 1 && p <= page + 1)
//                                             ) {
//                                                 return (
...
//                                         <PaginationItem>
//                                             <PaginationNext
//                                                 onClick={() => setPage(p => Math.min(cityAssignments.meta.totalPages, p + 1))}
//                                                 disabled={page === cityAssignments.meta.totalPages}
//                                                 className={page === cityAssignments.meta.totalPages ? "pointer-events-none opacity-50" : "cursor-pointer"}
//                                             />
//                                         </PaginationItem>
//                                     </PaginationContent>
//                                 </Pagination>
